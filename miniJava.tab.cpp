...
{
  "$end", "error", "$undefined", "'&'", "'|'", "'-'", "'+'", "'*'", "'/'",
  "NUMBER", "CLASS", "EXTENDS", "PRIVATE", "PUBLIC", "RETURN",
  "BLOCK_COMMENT", "LINE_COMMENT", "ID", "$accept", "Program", YY_NULL
};
#endif
